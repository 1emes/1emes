...
<picture>
  ...
  <img width="100%" alt="Um balão estratosférico com carga útil de instrumentos sobre o horizonte luminoso da Terra, um CubeSat ao lado e uma rede neural desenhada no céu noturno" src="./assets/hero-dark.png" />
</picture>
</p>
...
<p align="center">
  <b>Construindo sistemas que percebem, aprendem e conectam.</b><br />
  <sub>Engenharia de Software @ UnB · Brasília, Brasil · IA · Embarcados · Fullstack</sub>
</p>

<p align="center">
  <a href="https://matheus-lemes.matheuslemesam.chatgpt.site">Portfólio</a> &nbsp;·&nbsp;
  <a href="https://github.com/1emes?tab=repositories">Projetos</a> &nbsp;·&nbsp;
...
Um encoder CNN combinado com decoders LSTM, GRU e Transformer, comparados lado a lado em legendagem automática de imagens.

**[Sensoriamento-CubeDesign2025](https://github.com/1emes/Sensoriamento-CubeDesign2025)** &nbsp;<sub><samp>C++ · OpenCV</samp></sub><br />
Detecção de embarcações em imagens de sensoriamento remoto, cruzada com dados AIS, para a equipe de CubeSat GamaCube Design.

**[ds18b20-Esp](https://github.com/1emes/ds18b20-Esp)** &nbsp;<sub><samp>C++ · ESP · IoT</samp></sub><br />
Um sensor de temperatura DS18B20 em um microcontrolador ESP, servido por um servidor web embarcado.
...
- **[Crusty](https://github.com/1emes/Crusty)** — Um compilador escrito em Rust — fork do projeto em equipe de Compiladores 1.
